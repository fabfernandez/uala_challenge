...
func TestFollowUseCase_FollowUser(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			useCase := NewFollowUseCase(followRepo, tweetRepo)
			
			err := useCase.FollowUser(ctx, tt.req)
...
func TestFollowUseCase_UnfollowUser(t *testing.T) {
	ctx := context.Background()
	...
	err := useCase.UnfollowUser(ctx, req)
	if err != nil {
		t.Errorf("Expected no error, got %v", err)
	}
...
func TestFollowUseCase_GetTimeline(t *testing.T) {
	ctx := context.Background()
	...
	tweets, err := useCase.GetTimeline(ctx, "user1")
	if err != nil {
		t.Errorf("Expected no error, got %v", err)
	}
...
func TestFollowUseCase_GetTimeline_EmptyFollows(t *testing.T) {
	ctx := context.Background()
